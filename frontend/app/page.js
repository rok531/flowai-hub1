    ...
    <div className="min-h-screen bg-black text-gray-100 flex flex-col">
      ...
      <header className="border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="text-2xl font-bold text-white">FlowAI Hub</div>
          {session && (
            <button
              onClick={signOut}
              disabled={loading}
              className="px-6 py-2 bg-gray-800 hover:bg-gray-700 rounded-lg text-sm font-medium transition disabled:opacity-50"
            >
              Sign Out
            </button>
          )}
      ...
      <main className="flex-1 flex items-center justify-center py-16 px-6">
        <div className="max-w-4xl w-full text-center">
          ...
          <Suspense fallback={<div className="h-12 bg-gray-900 rounded-xl animate-pulse" />}>
            ...
            {errorMsg && (
              <div className="mb-8 p-4 bg-red-900/60 border border-red-700 rounded-xl text-red-300">
                {errorMsg}
              </div>
            )}
          </Suspense>
          ...
          {!session ? (
            <div className="max-w-md mx-auto bg-gray-900 p-10 rounded-2xl shadow-2xl border border-gray-800">
              ...
              <input
                ...
                className="w-full p-4 mb-5 bg-gray-800 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 transition"
              />
              ...
              <input
                ...
                className="w-full p-4 mb-8 bg-gray-800 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 transition"
              />
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  onClick={signUp}
                  disabled={loading}
                  className="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-4 rounded-xl font-medium transition disabled:opacity-50"
                >
                ...
                <button
                  onClick={signIn}
                  disabled={loading}
                  className="flex-1 bg-green-600 hover:bg-green-700 text-white py-4 rounded-xl font-medium transition disabled:opacity-50"
                >
            ...
            <div className="max-w-3xl mx-auto bg-gray-900 p-12 rounded-2xl shadow-2xl border border-gray-800">
              ...
              <div className="text-left">
                ...
                <p className="text-gray-400 text-sm">
                  Once connected, run a test Zoom meeting — tasks will appear in Slack with Approve button.
                </p>
              </div>
            </div>
          )}
